...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123):
        ...
        '''
        Adding simulation Component(id=pyr_single_comp_ca type=Simulation) of network/component: single_pyr_cell_network (Type: networkWithTemperature:  temperature=310.15 (SI temperature))
    ...
    def save_results(self):
        ...
        f_output0_f2 = open('pyr_single_comp_ca.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...

        for i in range(num_points):
            f_output0_f2.write('%e\t%e\t\n' % (py_v_time[i], py_v_pop0_0__v_output0[i], ))
        f_output0_f2.close()
        print("Saved data to: pyr_single_comp_ca.dat")
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=700, dt=0.005, seed=123)
