...
Components:
    ...
    net1 (Type: networkWithTemperature:  temperature=279.45 (SI temperature))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        '''
        Adding simulation Component(id=sim1 type=Simulation) of network/component: net1 (Type: networkWithTemperature:  temperature=279.45 (SI temperature))
        ...
        # Line, plotting: holderCellPop_min100[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_min100_holderCellPop_min100[0].test_kfast_fopen", "m_holderCell_min100_holderCellPop_min100[0].test_kfast_fopen", 1, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_min80[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_min80_holderCellPop_min80[0].test_kfast_fopen", "m_holderCell_min80_holderCellPop_min80[0].test_kfast_fopen", 2, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_min60[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_min60_holderCellPop_min60[0].test_kfast_fopen", "m_holderCell_min60_holderCellPop_min60[0].test_kfast_fopen", 3, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_min40[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_min40_holderCellPop_min40[0].test_kfast_fopen", "m_holderCell_min40_holderCellPop_min40[0].test_kfast_fopen", 4, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_min20[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_min20_holderCellPop_min20[0].test_kfast_fopen", "m_holderCell_min20_holderCellPop_min20[0].test_kfast_fopen", 5, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_0[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_0_holderCellPop_0[0].test_kfast_fopen", "m_holderCell_0_holderCellPop_0[0].test_kfast_fopen", 6, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_20[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_20_holderCellPop_20[0].test_kfast_fopen", "m_holderCell_20_holderCellPop_20[0].test_kfast_fopen", 7, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_40[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_40_holderCellPop_40[0].test_kfast_fopen", "m_holderCell_40_holderCellPop_40[0].test_kfast_fopen", 8, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_60[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_60_holderCellPop_60[0].test_kfast_fopen", "m_holderCell_60_holderCellPop_60[0].test_kfast_fopen", 9, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_80[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_80_holderCellPop_80[0].test_kfast_fopen", "m_holderCell_80_holderCellPop_80[0].test_kfast_fopen", 10, 1, 0.8, 0.9, 2)
        # Line, plotting: holderCellPop_100[0]/test/kfast/fopen
        self.display_d1.addexpr("m_holderCell_100_holderCellPop_100[0].test_kfast_fopen", "m_holderCell_100_holderCellPop_100[0].test_kfast_fopen", 1, 1, 0.8, 0.9, 2)
        ...
        # ######################   Display: self.display_n_inf
        self.display_n_inf = h.Graph(0)
        self.display_n_inf.size(0,h.tstop,-80.0,50.0)
        self.display_n_inf.view(0, -80.0, h.tstop, 130.0, 80, 330, 330, 250)
        h.graphList[0].append(self.display_n_inf)
        # Line, plotting: rampCellPop0[0]/test/kfast/n/inf
        self.display_n_inf.addexpr("m_rampCell0_rampCellPop0[0].test_kfast_n_inf", "m_rampCell0_rampCellPop0[0].test_kfast_n_inf", 1, 1, 0.8, 0.9, 2)

        # ######################   Display: self.display_n_tau
        self.display_n_tau = h.Graph(0)
        self.display_n_tau.size(0,h.tstop,-80.0,50.0)
        self.display_n_tau.view(0, -80.0, h.tstop, 130.0, 80, 330, 330, 250)
        h.graphList[0].append(self.display_n_tau)
        # Line, plotting: rampCellPop0[0]/test/kfast/n/tau
        self.display_n_tau.addexpr("m_rampCell0_rampCellPop0[0].test_kfast_n_tau", "m_rampCell0_rampCellPop0[0].test_kfast_n_tau", 1, 1, 0.8, 0.9, 2)



        # ######################   File to save: kfast.rampV.lems.dat (rampCellV)
        ...
        # ######################   File to save: kfast.n.inf.lems.dat (n_inf_of1)
        # Column: rampCellPop0[0]/test/kfast/n/inf
        h(' objectvar v_n_n_inf_of1 ')
        h(' { v_n_n_inf_of1 = new Vector() } ')
        h(' { v_n_n_inf_of1.record(&m_rampCell0_rampCellPop0[0].test_kfast_n_inf) } ')
        h.v_n_n_inf_of1.resize((h.tstop * h.steps_per_ms) + 1)

        # ######################   File to save: kfast.n.tau.lems.dat (n_tau_of1)
        # Column: rampCellPop0[0]/test/kfast/n/tau
        h(' objectvar v_n_n_tau_of1 ')
        h(' { v_n_n_tau_of1 = new Vector() } ')
        h(' { v_n_n_tau_of1.record(&m_rampCell0_rampCellPop0[0].test_kfast_n_tau) } ')
        h.v_n_n_tau_of1.resize((h.tstop * h.steps_per_ms) + 1)
    ...
    def save_results(self):
        ...
        self.display_n_inf.exec_menu("View = plot")
        self.display_n_tau.exec_menu("View = plot")
        ...
        f_rampCellV_f2 = open('kfast.rampV.lems.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...

        for i in range(num_points):
            f_rampCellV_f2.write('%e\t%e\t\n' % (py_v_time[i], py_v_v_rampCellV[i], ))
        f_rampCellV_f2.close()
        print("Saved data to: kfast.rampV.lems.dat")

        # ######################   File to save: kfast.n.inf.lems.dat (n_inf_of1)
        py_v_n_n_inf_of1 = [ float(x ) for x in h.v_n_n_inf_of1.to_python() ]  # Convert to Python list for speed, variable has dim: none

        f_n_inf_of1_f2 = open('kfast.n.inf.lems.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...

        for i in range(num_points):
            f_n_inf_of1_f2.write('%e\t%e\t\n' % (py_v_time[i], py_v_n_n_inf_of1[i], ))
        f_n_inf_of1_f2.close()
        print("Saved data to: kfast.n.inf.lems.dat")

        # ######################   File to save: kfast.n.tau.lems.dat (n_tau_of1)
        py_v_n_n_tau_of1 = [ float(x  / 1000.0) for x in h.v_n_n_tau_of1.to_python() ]  # Convert to Python list for speed, variable has dim: time

        f_n_tau_of1_f2 = open('kfast.n.tau.lems.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...

        for i in range(num_points):
            f_n_tau_of1_f2.write('%e\t%e\t\n' % (py_v_time[i], py_v_n_n_tau_of1[i], ))
        f_n_tau_of1_f2.close()
        print("Saved data to: kfast.n.tau.lems.dat")
